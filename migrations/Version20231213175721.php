 ...
 */
final class Version20231213175721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, conference_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_5E90F6D6604B8382 (conference_id), INDEX IDX_5E90F6D6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE inscription ADD CONSTRAINT FK_5E90F6D6604B8382 FOREIGN KEY (conference_id) REFERENCES conference (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription DROP FOREIGN KEY FK_5E90F6D6604B8382');
